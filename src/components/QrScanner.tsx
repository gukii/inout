...
/*
  return(
    <div className="bg-amber-300 backdrop-blur-xl z-20 max-w-md absolute right-5 bottom-5 rounded-lg p-1 shadow">
        <div className="flex justify-between items-center">
            <div className="whitespace-normal text-slate-800  text-sm inline-flex space-x-1 items-center">
                <span>{msg}</span>
            </div>
        </div>
    </div>
...
*/
  ...
  return(
    <div className="bg-amber-300 backdrop-blur-xl z-20 max-w-md right-5 bottom-5 rounded-lg p-1 shadow">
        <div className="flex justify-between items-center">
...
function QrScan() {
  ...
  const renderLine = ( data?:string, item?:any ) => {
    return (
      <li key={item?.checkIn?.timeStr}  className="flex w-80">

            { !item.checkOut && <svg height="1.5em" width="1.5em" className="flex-none w-7 h-7" aria-hidden="true" focusable="false" data-prefix="far" data-icon="arrow-alt-circle-right"  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor" d="M504 256C504 119 393 8 256 8S8 119 8 256s111 248 248 248 248-111 248-248zm-448 0c0-110.5 89.5-200 200-200s200 89.5 200 200-89.5 200-200 200S56 366.5 56 256zm72 20v-40c0-6.6 5.4-12 12-12h116v-67c0-10.7 12.9-16 20.5-8.5l99 99c4.7 4.7 4.7 12.3 0 17l-99 99c-7.6 7.6-20.5 2.2-20.5-8.5v-67H140c-6.6 0-12-5.4-12-12z"></path>
              </svg>
            }

            { item.checkOut &&
              <svg height="1.5em" width="1.5em" className="flex-none w-7 h-7" aria-hidden="true" focusable="false" data-prefix="far" data-icon="arrow-alt-circle-left"  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="#FF6347" d="M8 256c0 137 111 248 248 248s248-111 248-248S393 8 256 8 8 119 8 256zm448 0c0 110.5-89.5 200-200 200S56 366.5 56 256 145.5 56 256 56s200 89.5 200 200zm-72-20v40c0 6.6-5.4 12-12 12H256v67c0 10.7-12.9 16-20.5 8.5l-99-99c-4.7-4.7-4.7-12.3 0-17l99-99c7.6-7.6 20.5-2.2 20.5 8.5v67h116c6.6 0 12 5.4 12 12z"></path>
              </svg>
            }

            <span style={ limitedText }>{data}</span>
      </li>)
  }
  /*
